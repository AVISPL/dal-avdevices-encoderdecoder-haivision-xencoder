...
public enum StreamControllingMetric {
	...
	STREAM_NETWORK_ADAPTIVE("StreamingNetworkAdaptive"),
	STREAM_LATENCY("StreamingLatency"),
	STREAM_ENCRYPTION("StreamingEncryption"),
	STREAM_PASSPHRASE("StreamingPassphrase"),
	//Listener Mode
